...
public sealed class Localizer
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Messages = new()
    {
        ...
        ["he"] = new()
        {
            ...
            ["public.look_description"] = "{0}/10 · {1}. {2}",
            ["public.look_description_short"] = "{0}/10 · {1}.",
        ...
        ["ru"] = new()
        {
            ...
            ["mail.welcome_body"] = "Привет, {0}!\n\nOREVOSH проверяет образ, а не человека: фото, куда вы идёте, и один честный совет, который можно применить до выхода.\n\nПроверить образ: {1}\n\nОтключить эти письма: {2}\n",
            ["mail.digest_subject"] = "Ваша неделя на OREVOSH",
            ["mail.digest_body"] = "Привет, {0}!\n\nВаши образы получили {1} огней и {2} комментариев за неделю.\n\n{3}Проверить образ: {4}\n\nОтключить эти письма: {5}\n",
