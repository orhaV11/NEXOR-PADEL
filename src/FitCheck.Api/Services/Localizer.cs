...
public sealed class Localizer
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Messages = new()
    {
        ...
        ["he"] = new()
        {
            ...
            ["push.fire"] = "{0} הדליק/ה אש על הלוק שלך",
            ["push.follow"] = "{0} עוקב/ת אחריך עכשיו",
            ["push.comment"] = "{0} הגיב/ה על הלוק שלך",
            ["push.mention"] = "{0} תייג/ה אותך בלוק",
            ["push.featured"] = "{0} הציג/ה את הלוק שלך",
            ["push.won"] = "הלוק שלך זכה באתגר של {0}",
            ["push.vote"] = "{0} הצביע/ה ללוק שלך",
            ["push.entry"] = "{0} נכנס/ה לאתגר שלך",
