...
public sealed class Localizer
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Messages = new()
    {
        ["en"] = new()
        {
            ...
            ["error.recap_failed"] = "Your month could not be written just now. Try again in a minute.",
            ["error.commissions_batch"] = "A report is between 1 and {0} rows. Split a larger file.",
            ["error.commission_row"] = "That report has a row this app cannot read ({0}): it needs a store, the partner's own id, an amount, a three-letter currency, and a state of expected, confirmed or reversed.",
            ["error.month_limit"] = "You've used this month's {0} checks. The month rolls forward day by day, so one comes back tomorrow.",
            ...
            ["error.interests_invalid"] = "Pick styles from the list, up to {0}.",
            ["error.brand_needs_verification"] = "A brand account is opened by us, not by ticking a box: write to us and we will set it up. It carries a brand's name in front of other people, so it is not something anyone can take.",
            ...
            ["email.billing_problem_subject"] = "Your OREVOSH Pro payment didn't go through",
            ["email.billing_problem_body"] = "Hi @{0},\n\nYour card was declined, so this month's OREVOSH Pro payment didn't go through. Nothing has been lost yet - Pro stays on until {1} while we try again.\n\nUpdate your card here:\n\n{2}\n\nIf you meant to stop, you don't have to do anything: Pro simply ends on that date and your account stays, with everything in it.",
            ["email.billing_ended_subject"] = "Your OREVOSH Pro has ended",
            ["email.billing_ended_body"] = "Hi @{0},\n\nYour OREVOSH Pro has ended. Your account, your looks and your wardrobe are all still there - you're back on the free plan.\n\nIf this wasn't what you wanted, you can start again any time:\n\n{1}",
            ...
            ["email.reset_body"] = "Someone asked to reset the password for @{0}. Tap this link within an hour to pick a new one:\n\n{1}\n\nIf this wasn't you, ignore this message and your password stays as it is.",
                        ["error.plan_limit"] = "That's today's {0} free checks. Pro gives you {1} a month, and the stylist sees your whole wardrobe. Or come back tomorrow.",
            ...
            ["error.items_too_many"] = "Up to {0} items on a look.",
            ["error.item_position_invalid"] = "The dot has to be on the photo.",
            ["error.board_week_invalid"] = "That week doesn't look right.",
            ...
            ["error.not_blocked"] = "You haven't blocked this account.",
            ...
            ["public.profile_title"] = "@{0} on OREVOSH",
            ["public.profile_description"] = "The looks @{0} checked on OREVOSH.",
            ["public.profile_looks"] = "Looks",
            ["public.profile_empty"] = "No looks yet.",
            ["public.not_found_title"] = "Nothing here",
            ["public.not_found_body"] = "This look isn't public. It may have been taken down, or it was never posted.",
            ["public.intent.Casual"] = "Casual",
            ["public.intent.Date"] = "Date",
            ["public.intent.Streetwear"] = "Streetwear",
            ["public.intent.OldMoney"] = "Old money",
            ["public.intent.Minimal"] = "Minimal",
            ["public.intent.Office"] = "Office",
            ["public.intent.Party"] = "Party",
            ["public.intent.Sport"] = "Sport",
            ["public.intent.Formal"] = "Formal",
            ["digest.off_title"] = "The weekly email is off",
            ["digest.off_body"] = "We won't send it again. You can turn it back on in Settings whenever you like.",
            ["digest.off_invalid_title"] = "That link didn't work",
            ["digest.off_invalid_body"] = "This link isn't valid any more. You can turn the weekly email off in Settings.",
            ["digest.off_settings"] = "Open Settings",
            ["mail.welcome_subject"] = "Welcome to OREVOSH",
            ["mail.welcome_body"] = "Hi {0},\n\nOREVOSH checks the look, never the person: a photo, where it is going, and one honest tip you can act on before you leave.\n\nCheck a look: {1}\n\nTo stop these emails: {2}\n",
        ...
        ["he"] = new()
        {
            ...
            ["error.recap_failed"] = "לא הצלחנו לכתוב את החודש שלך כרגע. כדאי לנסות שוב בעוד דקה.",
            ["error.commissions_batch"] = "דוח הוא בין שורה אחת ל-{0}. קובץ גדול יותר צריך לפצל.",
            ["error.commission_row"] = "בדוח יש שורה שהאפליקציה לא יודעת לקרוא ({0}): צריך חנות, מזהה של השותף, סכום, מטבע בן שלוש אותיות, ומצב expected, confirmed או reversed.",
            ["error.month_limit"] = "מכסת החודש, {0} בדיקות, נוצלה. החודש מתגלגל יום-יום, אז מחר חוזרת עוד אחת.",
            ...
            ["error.interests_invalid"] = "בוחרים סגנונות מהרשימה, עד {0}.",
            ["error.brand_needs_verification"] = "חשבון מותג נפתח אצלנו, לא בסימון וי: כתבו לנו ונסדר את זה. הוא נושא שם של מותג מול אנשים אחרים, אז זה לא משהו שכל אחד יכול לקחת.",
            ...
            ["email.billing_problem_subject"] = "התשלום עבור OREVOSH Pro לא עבר",
            ["email.billing_problem_body"] = "היי @{0},\n\nהכרטיס נדחה, אז התשלום עבור OREVOSH Pro החודש לא עבר. עדיין לא איבדת כלום - פרו נשאר פעיל עד {1} בזמן שאנחנו מנסים שוב.\n\nלעדכון הכרטיס:\n\n{2}\n\nאם התכוונת לעצור - אין מה לעשות: פרו פשוט מסתיים בתאריך הזה והחשבון נשאר, עם כל מה שבו.",
            ["email.billing_ended_subject"] = "ה-OREVOSH Pro שלך הסתיים",
            ["email.billing_ended_body"] = "היי @{0},\n\nה-OREVOSH Pro שלך הסתיים. החשבון, הלוקים והארון שלך נשארו במקום - חזרת למסלול החינמי.\n\nאם זה לא מה שרצית, אפשר להתחיל שוב מתי שתרצה:\n\n{1}",
            ...
            ["email.reset_body"] = "מישהו ביקש לאפס את הסיסמה של @{0}. לוחצים על הקישור תוך שעה כדי לבחור סיסמה חדשה:\n\n{1}\n\nאם זה לא מכם, מתעלמים והסיסמה נשארת כמו שהיא.",
                        ["error.plan_limit"] = "אלה {0} הבדיקות החינמיות של היום. ב-Pro יש {1} בחודש, והסטייליסט רואה את כל הארון. או שחוזרים מחר.",
            ...
            ["error.items_too_many"] = "עד {0} פריטים על לוק.",
            ["error.item_position_invalid"] = "הנקודה צריכה להיות על התמונה.",
            ["error.board_week_invalid"] = "השבוע הזה לא נראה נכון.",
            ...
            ["error.not_blocked"] = "החשבון הזה לא חסום.",
            ["error.blocked"] = "אי אפשר לפעול מול החשבון הזה.",
            ...
            ["public.profile_title"] = "@{0} ב-OREVOSH",
            ["public.profile_description"] = "הלוקים של @{0} ב-OREVOSH.",
            ["public.profile_looks"] = "לוקים",
            ["public.profile_empty"] = "אין עדיין לוקים.",
            ["public.not_found_title"] = "אין כאן כלום",
            ["public.not_found_body"] = "הלוק הזה לא פומבי. יכול להיות שהוא הוסר, או שהוא מעולם לא פורסם.",
            ["public.intent.Casual"] = "קז'ואל",
            ["public.intent.Date"] = "דייט",
            ["public.intent.Streetwear"] = "סטריטוור",
            ["public.intent.OldMoney"] = "אולד מאני",
            ["public.intent.Minimal"] = "מינימלי",
            ["public.intent.Office"] = "משרד",
            ["public.intent.Party"] = "מסיבה",
            ["public.intent.Sport"] = "ספורט",
            ["public.intent.Formal"] = "אירוע",
            ["digest.off_title"] = "המייל השבועי כבוי",
            ["digest.off_body"] = "לא נשלח אותו שוב. אפשר להחזיר אותו בהגדרות בכל רגע.",
            ["digest.off_invalid_title"] = "הקישור הזה לא עבד",
            ["digest.off_invalid_body"] = "הקישור הזה כבר לא תקף. אפשר לכבות את המייל השבועי בהגדרות.",
            ["digest.off_settings"] = "לפתוח הגדרות",
            ["mail.welcome_subject"] = "ברוכים הבאים ל-OREVOSH",
            ["mail.welcome_body"] = "היי {0},\n\nOREVOSH בודק את הלוק, אף פעם לא את האדם: תמונה, לאן הולכים, וטיפ אחד ישר שאפשר ליישם לפני שיוצאים.\n\nלבדוק לוק: {1}\n\nלהפסיק את המיילים האלה: {2}\n",
        ...
        ["ar"] = new()
        {
            ...
            ["error.recap_failed"] = "تعذّرت كتابة شهرك الآن. جرّب بعد دقيقة.",
            ["error.commissions_batch"] = "التقرير بين صف واحد و{0} صفًا. الملف الأكبر يُقسّم.",
            ["error.commission_row"] = "في التقرير صف لا يمكن قراءته ({0}): يلزم متجر ومعرّف الشريك ومبلغ وعملة من ثلاثة أحرف وحالة expected أو confirmed أو reversed.",
            ["error.month_limit"] = "استُخدمت حصة الشهر، {0} تقييمًا. الشهر يتقدم يومًا بيوم، فغدًا يعود واحد.",
            ...
            ["error.interests_invalid"] = "الأساليب تُختار من القائمة، حتى {0}.",
            ["error.brand_needs_verification"] = "يُفتح حساب العلامة التجارية من قبلنا، لا بوضع علامة: اكتب لنا وسنقوم بإعداده. إنه يحمل اسم علامة أمام الآخرين، لذلك لا يمكن لأي شخص أخذه.",
            ...
            ["email.billing_problem_subject"] = "لم تتم عملية دفع OREVOSH Pro",
            ["email.billing_problem_body"] = "مرحبًا @{0},\n\nتم رفض بطاقتك، لذلك لم تتم عملية الدفع لهذا الشهر. لم تفقد شيئًا بعد - يبقى Pro فعّالًا حتى {1} بينما نحاول مرة أخرى.\n\nلتحديث بطاقتك:\n\n{2}\n\nإذا كنت تريد الإيقاف، فلا حاجة لفعل شيء: ينتهي Pro في ذلك التاريخ ويبقى حسابك بكل ما فيه.",
            ["email.billing_ended_subject"] = "انتهى اشتراك OREVOSH Pro",
            ["email.billing_ended_body"] = "مرحبًا @{0},\n\nانتهى اشتراك OREVOSH Pro. حسابك وإطلالاتك وخزانتك ما زالت موجودة - عدت إلى الخطة المجانية.\n\nإذا لم يكن هذا ما أردت، يمكنك البدء من جديد في أي وقت:\n\n{1}",
            ...
            ["email.reset_body"] = "طلب أحدهم إعادة تعيين كلمة المرور لحساب @{0}. نقرة على هذا الرابط خلال ساعة لاختيار كلمة جديدة:\n\n{1}\n\nإن لم يكن هذا منك، يمكن تجاهل الرسالة وتبقى كلمة المرور كما هي.",
                        ["error.plan_limit"] = "هذه تقييمات اليوم المجانية ({0}). مع Pro لديك {1} شهريًا، والمنسّق يرى خزانتك كلها. أو عُد غدًا.",
            ...
            ["error.items_too_many"] = "حتى {0} قطعة على الإطلالة.",
            ["error.item_position_invalid"] = "النقطة يجب أن تكون على الصورة.",
            ["error.board_week_invalid"] = "هذا الأسبوع لا يبدو صحيحًا.",
            ...
            ["error.not_blocked"] = "هذا الحساب غير محظور.",
            ["error.blocked"] = "لا يمكن التفاعل مع هذا الحساب.",
            ...
            ["public.profile_title"] = "@{0} على OREVOSH",
            ["public.profile_description"] = "إطلالات @{0} على OREVOSH.",
            ["public.profile_looks"] = "الإطلالات",
            ["public.profile_empty"] = "لا توجد إطلالات بعد.",
            ["public.not_found_title"] = "لا شيء هنا",
            ["public.not_found_body"] = "هذه الإطلالة ليست عامة. ربما أُزيلت، أو لم تُنشر أبدًا.",
            ["public.intent.Casual"] = "كاجوال",
            ["public.intent.Date"] = "موعد",
            ["public.intent.Streetwear"] = "ستريت وير",
            ["public.intent.OldMoney"] = "أولد موني",
            ["public.intent.Minimal"] = "مينيمال",
            ["public.intent.Office"] = "مكتب",
            ["public.intent.Party"] = "حفلة",
            ["public.intent.Sport"] = "رياضي",
            ["public.intent.Formal"] = "مناسبة",
            ["digest.off_title"] = "البريد الأسبوعي متوقف",
            ["digest.off_body"] = "لن نرسله مرة أخرى. يمكنك تشغيله من الإعدادات في أي وقت.",
            ["digest.off_invalid_title"] = "هذا الرابط لم يعمل",
            ["digest.off_invalid_body"] = "هذا الرابط لم يعد صالحًا. يمكنك إيقاف البريد الأسبوعي من الإعدادات.",
            ["digest.off_settings"] = "افتح الإعدادات",
            ["mail.welcome_subject"] = "أهلًا بك في OREVOSH",
            ["mail.welcome_body"] = "مرحبًا {0}،\n\nOREVOSH يفحص الإطلالة لا الشخص: صورة، وإلى أين أنت ذاهب، ونصيحة واحدة صادقة يمكنك تطبيقها قبل الخروج.\n\nافحص إطلالة: {1}\n\nلإيقاف هذه الرسائل: {2}\n",
        ...
        ["ru"] = new()
        {
            ...
            ["error.recap_failed"] = "Не получилось написать твой месяц. Попробуй через минуту.",
            ["error.commissions_batch"] = "Отчёт — от одной строки до {0}. Файл больше нужно разделить.",
            ["error.commission_row"] = "В отчёте есть нечитаемая строка ({0}): нужны магазин, идентификатор партнёра, сумма, трёхбуквенная валюта и состояние expected, confirmed или reversed.",
            ["error.month_limit"] = "Месячная квота исчерпана: {0}. Месяц скользит по дням, так что завтра вернётся одна.",
            ...
            ["error.interests_invalid"] = "Выбери стили из списка, не больше {0}.",
            ["error.brand_needs_verification"] = "Аккаунт бренда открываем мы, а не галочка: напиши нам, и мы всё настроим. Он несёт имя бренда перед другими людьми, так что его нельзя просто взять.",
            ...
            ["email.billing_problem_subject"] = "Платёж за OREVOSH Pro не прошёл",
            ["email.billing_problem_body"] = "Привет, @{0}.\n\nКарта отклонена, поэтому платёж за этот месяц не прошёл. Пока ничего не потеряно - Pro работает до {1}, пока мы пробуем снова.\n\nОбновить карту:\n\n{2}\n\nЕсли ты хотел отменить - делать ничего не нужно: Pro просто закончится в эту дату, а аккаунт останется со всем содержимым.",
            ["email.billing_ended_subject"] = "Твой OREVOSH Pro завершён",
            ["email.billing_ended_body"] = "Привет, @{0}.\n\nТвой OREVOSH Pro завершён. Аккаунт, образы и гардероб на месте - ты снова на бесплатном тарифе.\n\nЕсли это не то, чего ты хотел - можно начать снова в любой момент:\n\n{1}",
            ...
            ["email.reset_body"] = "Кто-то попросил сбросить пароль для @{0}. Нажми на ссылку в течение часа, чтобы придумать новый:\n\n{1}\n\nЕсли это не ты, не обращай внимания, и пароль останется прежним.",
                        ["error.plan_limit"] = "Это твои {0} бесплатные проверки на сегодня. В Pro их {1} в месяц, и стилист видит весь гардероб. Или возвращайся завтра.",
            ...
            ["error.items_too_many"] = "До {0} вещей на образ.",
            ["error.item_position_invalid"] = "Точка должна быть на фото.",
            ["error.board_week_invalid"] = "Эта неделя выглядит странно.",
            ...
            ["error.not_blocked"] = "Этот аккаунт не заблокирован.",
            ["error.blocked"] = "С этим аккаунтом нельзя взаимодействовать.",
            ...
            ["public.profile_title"] = "@{0} на OREVOSH",
            ["public.profile_description"] = "Образы @{0} на OREVOSH.",
            ["public.profile_looks"] = "Образы",
            ["public.profile_empty"] = "Пока нет образов.",
            ["public.not_found_title"] = "Здесь пусто",
            ["public.not_found_body"] = "Этот образ не публичный. Возможно, его удалили или никогда не публиковали.",
            ["public.intent.Casual"] = "Кэжуал",
            ["public.intent.Date"] = "Свидание",
            ["public.intent.Streetwear"] = "Стритвир",
            ["public.intent.OldMoney"] = "Олд мани",
            ["public.intent.Minimal"] = "Минимал",
            ["public.intent.Office"] = "Офис",
            ["public.intent.Party"] = "Вечеринка",
            ["public.intent.Sport"] = "Спорт",
            ["public.intent.Formal"] = "Торжество",
            ["digest.off_title"] = "Еженедельное письмо отключено",
            ["digest.off_body"] = "Мы больше его не пришлём. Включить обратно можно в настройках.",
            ["digest.off_invalid_title"] = "Ссылка не сработала",
            ["digest.off_invalid_body"] = "Эта ссылка больше недействительна. Отключить еженедельное письмо можно в настройках.",
            ["digest.off_settings"] = "Открыть настройки",
            ["mail.welcome_subject"] = "Добро пожаловать в OREVOSH",
            ["mail.welcome_body"] = "Привет, {0},\n\nOREVOSH проверяет образ, а не человека: фото, куда ты идёшь, и один честный совет, который можно применить до выхода.\n\nПроверить образ: {1}\n\nОтключить эти письма: {2}\n",
