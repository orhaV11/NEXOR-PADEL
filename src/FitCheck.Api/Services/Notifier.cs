...
/// a block (Round 11): <see cref="AddOnceAsync"/> drops a notification whose actor is on either side of one with the
/// person; the routes that would send one for a refused act never get this far.
/// </summary>
