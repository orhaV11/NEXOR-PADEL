    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <div className="section-tag mx-auto inline-flex mb-4">Newsletter</div>

          <h2 className="section-heading mb-4">
            Stay Ahead<br />
            <span className="text-[#b5f72e]">of the Game</span>
          </h2>

          <p className="text-white/40 mb-10 max-w-md mx-auto">
            Get exclusive deals, early access to new drops, expert tips and curated gear picks — straight to your inbox.
          </p>
          ...
          {!submitted ? (
            ...
            >
              ...
              <p className="text-white/40 text-sm">Welcome to the NEXOR community. Watch your inbox for exclusive content.</p>
            </motion.div>
          )}
